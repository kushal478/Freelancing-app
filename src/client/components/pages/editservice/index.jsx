								...
								<div className="row">
									<div className="col-lg-12">
										<div className="form-group">
											...
											<input className="form-control" type="text" value="Web Design in Argentina" required />
										</div>
									</div>
									<div className="col-lg-6">
										<div className="form-group">
											...
											<input className="form-control" type="text" value="150000" required />
										</div>
									</div>
									<div className="col-lg-6">
										<div className="form-group">
											...
											<input className="form-control" type="text" value="Argentina" required />
										</div>
									</div>
								</div>
							</div>
									...
									<div className="row form-row membership-cont">
										<div className="col-lg-6">
											<div className="form-group">
												...
												<input type="text" className="form-control" value="Web Design" />
											</div>
										</div>
									...
									<div className="row form-row membership-cont">
										<div className="col-lg-6">
											<div className="form-group">
												...
												<input type="text" className="form-control" value="Seo" />
											</div>
										</div>
										<div className="col-12 col-md-2 col-lg-2">
											<label>&nbsp;</label>	<a href="#" className="btn btn-danger trash"><i className="far fa-times-circle"></i></a>
								...
								<div className="row">
									<div className="col-lg-12">
										<div className="form-group">
											...
											<textarea className="form-control service-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
										</div>
									</div>
								</div>
							</div>

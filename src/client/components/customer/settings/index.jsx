									...
									<form>
											...
											<div className="form-group col-xl-12">
												<div className="media align-items-center mb-3">
													...
													<div className="media-body">
														...
														<div className="jstinput">	<a href="javascript:void(0);" className="avatar-view-btn browsephoto openfile">Browse</a>
														</div>
													</div>
												</div>
											</div>
										...
										<div className="row">
											...
											<div className="form-group col-xl-6">
												...
												<input type="text" className="form-control datepicker" autocomplete="off" name="dob" value="01-01-1970" />
											</div>
											<div className="col-xl-12">
											...
											<div className="form-group col-xl-12">
												...
												<input type="text" className="form-control" name="address" value="" />
											</div>
											<div className="form-group col-xl-6">
											...
											<div className="form-group col-xl-6">
												...
												<input type="text" className="form-control" name="pincode" value="665487" />
											</div>
											<div className="form-group col-xl-12">
